...
Go [here](docs/hmesh_description.md) to find a description of [HMesh](src/hgeom/hmesh/elements/HMesh.java) and to know
how to edit a [HMesh](src/hgeom/hmesh/elements/HMesh.java)
...
A [HMesh](src/hgeom/hmesh/elements/HMesh.java) can be automatically generated from a list of polygons where each polygon
...
To generate a [HMesh](src/hgeom/hmesh/elements/HMesh.java) from this mesh, we first create a **FaceSource** from the
...
generated [HMesh](src/hgeom/hmesh/elements/HMesh.java) is always consistent
...
Then a [HMesh2D](src/hgeom/hmesh/elements/HMesh2D.java) (a version of [HMesh](src/hgeom/hmesh/elements/HMesh.java) for
...
If **3D coordinates** are attached to the vertices, a [HMesh3D](src/hgeom/hmesh/elements/HMesh3D.java) can similarly be
...
A [HMesh](src/hgeom/hmesh/elements/HMesh.java) can automatically be generated from a list of edges where each edge is
...
To generate a [HMesh](src/hgeom/hmesh/elements/HMesh.java) from this mesh, we first create a **EdgeSource** from the
collection of edges:
...
a [PolygonWindingProvider](src/hgeom/hmesh/winding/PolygonWindingProvider.java):
